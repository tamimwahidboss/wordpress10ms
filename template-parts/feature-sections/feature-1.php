        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="section-title text-center">
                    <p><?php echo isset($options['v1-feature-title-p']) ? esc_html($options['v1-feature-title-p']) : ''; ?></p>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="feature-cta bg-cover bg-center text-white" style="background-image: url('<?php echo isset($options['v1-feature-cta-bg']['url']) ? esc_url($options['v1-feature-cta-bg']['url']) : 'assets/img/home1/wave.png'; ?>')">
                            <p><?php echo isset($options['v1-feature-cta-p']) ? esc_html($options['v1-feature-cta-p']) : ''; ?></p>
                        </div>
                    </div>
                </div>
            </div>
