            ...
            <div class="col-12 col-xl-6 col-md-6 offset-md-3 text-center">
                <div class="section-title section__title_3 mb-30" data-aos="fade-up" data-aos-delay="100">
                    <h6>
                        ...
                        <?php echo isset( $options['v7-secvice-sec-h6'] ) ? esc_html( $options['v7-secvice-sec-h6'] ) : ''; ?>
                    </h6>
                    <h2><?php echo isset( $options['v7-secvice-sec-h2'] ) ? esc_html( $options['v7-secvice-sec-h2'] ) : ''; ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                foreach ( $options['v7-service-repeater'] as $repeat_service ) {
                    ...
                    <div class="col-lg-4 col-md-6 mt-30" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-element text-center">
                            ...
                            <h4><?php echo isset( $repeat_service['v7-single-service-h4'] ) ? esc_html( $repeat_service['v7-single-service-h4'] ) : ''; ?></h4>
                            <p><?php echo isset( $repeat_service['v7-single-service-des'] ) ? esc_html( $repeat_service['v7-single-service-des'] ) : ''; ?></p>
                            <a href="<?php echo isset( $repeat_service['v7-single-service-btn-link']['url'] ) ? esc_url( $repeat_service['v7-single-service-btn-link']['url'] ) : '#' ; ?>" class="theme-btn">
                                <?php echo isset( $repeat_service['v7-single-service-btn-text'] ) ? esc_html( $repeat_service['v7-single-service-btn-text'] ) : ''; ?>
                                <i class="<?php echo isset( $repeat_service['v7-single-service-btn-icon'] ) ? esc_attr( $repeat_service['v7-single-service-btn-icon'] ) : ''; ?>"></i>
                            </a>
                        </div>
                    </div>
                    <?php
