        ...
        <div class="row text-center mb-30">
            <div class="col-lg-8 p-lg-0 col-12 offset-lg-2">
                <div class="section-title">
                    <p><?php echo isset( $options['v9-service-p'] ) ? esc_html( $options['v9-service-p'] ) : ''; ?></p>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="single-service">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo isset( $repeater_box['v9-service-box-p'] ) ? esc_html( $repeater_box['v9-service-box-p'] ) : ''; ?></p>
                            </div>
                        </div>
                    </div>
                    <?php
