        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-12 text-center">
                <div class="section-title mb-30">
                    <p><?php echo isset( $options['v4-service-p'] ) ? esc_html( $options['v4-service-p'] ) : ''; ?></p>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="single-service-vcard">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo isset( $repeater_box['v4-service-box-p'] ) ? esc_html( $repeater_box['v4-service-box-p'] ) : ''; ?></p>
                            </div>
                        </div>
                    </div>
                    <?php
