        ...
        <div class="row mb-50">
            <div class="col-12 col-lg-12">
                <div class="section-title text-white text-center">
                    <p>
                        <?php echo isset( $options['v2-service-p'] ) ? esc_html( $options['v2-service-p'] ) : ''; ?>
                    </p>
                    <h1>
                    ...
                    <div class="col-md-6 col-xl-4 col-12">
                        <div class="single-service-box">
                            ...
                            <div class="content-visible">
                                ...
                                <p>
                                    <?php echo isset( $repeater_box['v2-service-box-p'] ) ? esc_html( $repeater_box['v2-service-box-p'] ) : ''; ?>
                                </p>
                            </div>
                            <div class="content-overlay">
                                ...
                                <p>
                                    <?php echo isset( $repeater_box['v2-service-box-pop-p'] ) ? esc_html( $repeater_box['v2-service-box-pop-p'] ) : ''; ?>
                                </p>
