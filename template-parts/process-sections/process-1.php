        ...
        <div class="row">
            <div class="col-12 col-lg-12 text-center">
                <div class="section-title style-3 mb-40">
                    ...
                    <p><?php echo isset( $options['v1-prosess-p'] ) ? esc_html( $options['v1-prosess-p'] ) : ''; ?></p>
                    ...
                    foreach( $repeater_boxes as $repeater_box ) {
                        ...
                        <div class="single-work-process">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo isset( $repeater_box['v1-single-prosess-p'] ) ? esc_html( $repeater_box['v1-single-prosess-p'] ) : ''; ?></p>
