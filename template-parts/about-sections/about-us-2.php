        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-12 pr-xl-5">
                <div class="section-title mb-30">
                    <p><?php echo isset( $options['v2-about-sec-title-p'] ) ? esc_html( $options['v2-about-sec-title-p'] ) : ''; ?></p>
                    <h1><?php echo isset( $options['v2-about-sec-title-h1'] ) ? esc_html( $options['v2-about-sec-title-h1'] ) : ''; ?></h1>
                </div>
