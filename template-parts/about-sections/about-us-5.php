            ...
            <div class="col-lg-6">
                <div class="section-title">
                    ...
                    <div data-aos="fade-left" data-aos-delay="150">
                        <p><?php echo isset( $options['v5-about-p'] ) ? esc_html( $options['v5-about-p'] ) : ''; ?></p>
                    </div>
                        ...
                        if ( isset( $options['v5-about-rate-rep'] ) && is_array( $options['v5-about-rate-rep'] ) ) {
                            ...
                            foreach( $repeater_boxes as $repeater_box ) {
                                ...
                                <div class="single-rate-item" data-aos="fade-up">
                                    ...
                                    <p><?php echo isset( $repeater_box['v5-about-rate-p'] ) ? esc_html( $repeater_box['v5-about-rate-p'] ) : ''; ?></p>
                                </div>
                                <?php
                            }
                        }
