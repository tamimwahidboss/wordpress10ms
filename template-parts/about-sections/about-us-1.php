                ...
                <div class="col-lg-6 col-12 pr-5">
                    <div class="section-title mb-30">
                        <?php if( isset( $options['about-sec-title-p'] ) ) : ?>
                            <p><?php echo esc_html( $options['about-sec-title-p'] ); ?></p>
                        <?php endif; ?>
                    ...
                    <?php if( isset( $options['about-sec-title-des'] ) ) : ?>
                        <p class="pr-lg-5"><?php echo esc_html( $options['about-sec-title-des'] ); ?></p>
                    <?php endif; ?>
                            ...
                            if( isset( $repeater_abt_box['about-sec-box-icon'], $repeater_abt_box['about-sec-box-title'], $repeater_abt_box['about-sec-box-des'] ) ) {
                                ...
                                <div class="about-icon-box style-2">
                                    ...
                                    <div class="content">
                                        ...
                                        <p><?php echo esc_html( $repeater_abt_box['about-sec-box-des'] ); ?></p>
                                    </div>
                                </div>
                                <?php
                            }
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-features-item">
                                ...
                                <div class="content">
                                    ...
                                    <p><?php echo isset( $repeater_abt_feature['about-sec-ft-item-des'] ) ? esc_html( $repeater_abt_feature['about-sec-ft-item-des'] ) : ''; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php
