        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 mt-30" data-aos="fade-up" data-aos-delay="100">
                <div class="contact__details">
                    ...
                    <p><?php echo isset( $options['v2-contact-sec-des'] ) ? esc_html( $options['v2-contact-sec-des'] ) : ''; ?></p>
                    <div class="action__call d-flex">
                        ...
                        <div class="content ml-20">
                            <p><?php echo isset( $options['v2-contact-sec-p'] ) ? esc_html( $options['v2-contact-sec-p'] ) : ''; ?></p>
