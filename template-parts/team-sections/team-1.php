        ...
        <div class="row align-items-center mb-40">
            <div class="col-12 col-md-6">
                <div class="section-title">
                    <p><?php echo isset( $options['v1-team-p'] ) ? esc_html( $options['v1-team-p'] ) : ''; ?></p>
                    <h1><?php echo isset( $options['v1-team-h1'] ) ? esc_html( $options['v1-team-h1'] ) : ''; ?></h1>
                </div>
            </div>
            <div class="col-12 col-md-6 mt-3 mt-md-0 text-md-right">
                <a href="<?php echo isset( $options['v1-team-btn']['url'] ) ? esc_url( $options['v1-team-btn']['url'] ) : '#'; ?>" class="theme-btn off-white">
                    <?php echo isset( $options['v1-team-btn']['text'] ) ? esc_html( $options['v1-team-btn']['text'] ) : 'Learn More'; ?> 
            ...
            if ( isset( $options['v1-team-rep'] ) && ! empty( $options['v1-team-rep'] ) ) {
                foreach ( $options['v1-team-rep'] as $repeater_box ) {
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="single-team-member <?php echo esc_attr( $classActive ); ?>">
                            ...
                            <div class="member-bio">
                                <h4><?php echo isset( $repeater_box['v1-team-box-h4'] ) ? esc_html( $repeater_box['v1-team-box-h4'] ) : ''; ?></h4>
                                <p><?php echo isset( $repeater_box['v1-team-box-p'] ) ? esc_html( $repeater_box['v1-team-box-p'] ) : ''; ?></p>
                            </div>
                                ...
                                if ( isset( $repeater_box['v1-team-soc-rep'] ) && ! empty( $repeater_box['v1-team-soc-rep'] ) ) {
                                    foreach ( $repeater_box['v1-team-soc-rep'] as $repeater_social ) {
                                        ...
                                        <a href="<?php echo isset( $repeater_social['v1-team-socLink']['url'] ) ? esc_url( $repeater_social['v1-team-socLink']['url'] ) : '#' ; ?>">
                                            <i class="<?php echo isset( $repeater_social['v1-team-box-icon'] ) ? esc_attr( $repeater_social['v1-team-box-icon'] ) : ''; ?>"></i>
                                        </a>
                                        <?php
                                    }
                                }
