            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-4 col-12 col-lg-6">
                    <div class="member-card mr-0 mr-xl-3">
                        ...
                        <div class="member-info">
                            ...
                            <p><?php echo isset( $options['v5-team-p'] ) ? esc_html( $options['v5-team-p'] ) : ''; ?></p>
                ...
                <div class="col-xl-4 mt-5 col-lg-6 col-12 mt-lg-0">
                    <div class="member-about">
                        ...
                        <p><?php echo isset( $options['v5-team-ele1-p'] ) ? esc_html( $options['v5-team-ele1-p'] ) : ''; ?></p>
                                ...
                                foreach ( $options['v5-team-about-rep'] as $repeater_box ) {
                                    ...
                                    <div class="single-contact-info d-flex">
                                        ...
                                        <div class="contact-info">
                                            <p><?php echo isset( $repeater_box['v5-team-about-info'] ) ? esc_html( $repeater_box['v5-team-about-info'] ) : ''; ?></p>
                                        </div>
                                    </div>
                                    <?php
                                }
                ...
                <div class="col-xl-4 mt-5 col-lg-12 col-12 mt-xl-0">
                    <div class="member-skills">
                        ...
                        <p><?php echo isset( $options['v5-team-ele3-p'] ) ? esc_html( $options['v5-team-ele3-p'] ) : ''; ?></p>
                        <?php
