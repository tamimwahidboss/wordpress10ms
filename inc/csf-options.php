...
if( class_exists( 'CSF' ) ) {
    ...
    CSF::createSection( $prefix, array(
        'id'    => 'global',
        'title' => esc_html__( 'Global', 'wp10ms' ),
    ) );
    ...
    // Attached footer section csf code file path.
    if ( isset( $options['ft-select'] ) && $options['ft-select'] === 'ft-1' ) {
        // Attached footer-section-1 csf code file path.
        include_once get_template_directory() . '/inc/csf-functions/footer-sections/footer-1.php';
    }
